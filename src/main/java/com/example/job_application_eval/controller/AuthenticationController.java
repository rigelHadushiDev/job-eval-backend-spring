...
public class AuthenticationController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<UserDto> signup(@Validated(OnSignUpUser.class) @RequestBody UserDto userDto) {
    ...
    public ResponseEntity<LogInResponse> authenticate(@Valid @RequestBody LoginUserDto loginUserDto,
        ...
        LogInResponse payload = authenticationService.authenticate(loginUserDto, request, response);
        return ResponseEntity.ok(payload);
    }


    @PostMapping("/resend")
    public ResponseEntity<String> resendAutoGeneratedPassword(@RequestParam String username) {
