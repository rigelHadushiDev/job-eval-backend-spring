...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public LogInResponse authenticate(LoginUserDto input) {
        ...
        if (!user.isPasswordChanged()) {
            if (user.getAutoGeneratedPasswordExpiresAt().plusMinutes(10).isBefore(LocalDateTime.now())) {
                throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Auto-generated password expired");
            }
        }
        ...
        return new LogInResponse(token, refreshToken, expiresIn, role);
    }
    ...
    public void sendVerificationEmail(UserEntity user, String rawVerificationCode) {
        ...
        String htmlMessage = "<html>"
                ...
                + "</div>"
                + "<p style=\"font-size: 16px;\">This password is valid until <strong>" + formattedExpiration + "</strong>.</p>"
                + "<p style=\"font-size: 16px;\">For security reasons, we strongly recommend changing your password immediately after your first login.</p>"
    ...
    public LogInResponse refreshAccessToken(String refreshToken) {
        ...
        return new LogInResponse(newAccessToken, refreshToken, newExpiresIn, user.getRole().name());
    }
}